# Battle for Bikini Bottom: Unofficial PC port (WIP) Modified Version built off Treedome.

[Joey's PC port branch I forked from.](https://github.com/joeyballentine/bfbb/tree/treedome)

Contains custom content of whatever I feel like, currently contains custom robots and a 'Buddy' system.

# AI SLOP DISCLAIMER
Uses AI Slop for the purpose of making custom mod stuff for private reasons primarily, this is mainly here for archival purposes if anyone chooses to look through and unslopify features they find interesting. I apologize if it's disappointing, I know it is.
---
