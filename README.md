...
[Joeys PC port branch I forked from.](https://github.com/joeyballentine/bfbb/tree/treedome)

Contains custom content of whatever I feel like, currently contains custom robots and a Buddy system.

Uses AI Slop for the purpose of making custom mod stuff for private reasons primarily.
...
[Discord](https://discord.gg/5gcmHBVFzU) Â· Decomp base: the `duplotron` branch Â·
Upstream decomp: [bfbbdecomp/bfbb](https://github.com/bfbbdecomp/bfbb) Â·
[Docs](docs/README.md)
